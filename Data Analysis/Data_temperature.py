# -*- coding: utf-8 -*-
"""
Created on Thu Mar 30 20:29:38 2023
...
pred = results.get_prediction(start=datetime(2013, 1, 1), end=datetime(2023, 1, 1) + pd.DateOffset(months=10*5), dynamic=True)
...
ax.plot(df.index, df['temperature'], label='Observed')
